...
def url_markup(videoid, duration, user_id, query, query_type):
    buttons = [
        [
           ...
           [InlineKeyboardButton(
                text=f"Others",
                callback_data=f"play_playlist {user_id}|Personal|Others",
            ),
           ],
        [
            InlineKeyboardButton(
    ...
    buttons = [
        ...
        [
           ...
           [InlineKeyboardButton(text="✚",callback_data=f"your_playlist {videoid}|{user_id}",
            ...
            InlineKeyboardButton(text="🔎",callback_data=f"lyrics {videoid}|{user_id}",
            ),
           ],
    ]
    return buttons
...
def audio_timer_markup_start(videoid, user_id, current_time, total_time):
    buttons = [
        [
            InlineKeyboardButton(text=f"{current_time}...VIBZZ...{total_time}",callback_data=f"timer_checkup_markup {videoid}|{user_id}",
            )
        ],
        [ 
            InlineKeyboardButton(text="▶️", callback_data=f"resumecb"),
